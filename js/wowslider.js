jQuery.fn.wowSlider = function(am) { var aI = jQuery; var H = this; var y = H.get(0);
    ...
    e = X ? aI(e) : X; if (e) { e.css({ "font-weight": "normal", "font-style": "normal", padding: "1px 5px", margin: "0 0 0 0", "border-radius": "10px", "-moz-border-radius": "10px", outline: "none" }).html(p).bind("contextmenu", function(c) { return false }).hide().appendTo(X || document.body).attr("target", "_blank") } var O = aI('<div class="ws_controls">').appendTo(au); if (ay[0]) { ay.appendTo(O) } if (am.controls) { var aj = aI('<a href="#" class="ws_next"><span>' + am.next + "<i></i><b></b></span></a>"); var ad = aI('<a href="#" class="ws_prev"><span>' + am.prev + "<i></i><b></b></span></a>");
        O.append(aj, ad);
        aj.bind("click", function(c) { aU(c, x + 1, 1) });
        ad.bind("click", function(c) { aU(c, x - 1, 0) }); if (am.controlsThumb) { var U = aI('<img alt="" src="">').appendTo(aj); var T = aI('<img alt="" src="">').appendTo(aj); var aN = aI('<img alt="" src="">').appendTo(ad); var aM = aI('<img alt="" src="">').appendTo(ad) } }
    ...
    function a() { am.autoPlay = !am.autoPlay; if (!am.autoPlay) { y.wsStop();
        ...
        window.onYouTubeIframeAPIReady = function() { at.youtube(true);
            at.start(x) } } var aZ = 0; if (am.fullScreen) { if (typeof NoSleep !== "undefined") { var aT = new NoSleep() } var w = (function() { var a2 = [
